...
<body>
    ...
    <div class=" mx-5 flex flex-col">
        <div class="pt-2 relative mx-auto mb-10 text-gray-600 " style="margin-top: -50px;">
            ...
            ?>
                    <a href="watch?video=<?= $video['name'] ?>">
                        ...
                        <div class="flex justify-between align-center px-2 pt-2">
                            <h1 class="font-medium"><?= htmlspecialchars($video['title']) ?></h1>
